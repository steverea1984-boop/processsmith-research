...
- [Sakana Fugu for ProcessSmith and OpenClaw](sakana-fugu/REPORT_sakana_fugu_2026-06-27.md) — Public-safe research brief on Sakana's hosted multi-agent model API, availability, Codex/API integration paths, ProcessSmith fit, and adoption cautions.
  ...
  - [Evaluation Pre-Registration](sakana-fugu/PREREG_sakana_fugu_2026-06-27.md) — The 15 frozen task items (research / code-review / loop-contract) plus the 3 scoring rubrics and answer keys, fixed before any model output.
  - [Findings](sakana-fugu/FINDINGS_sakana_fugu_2026-06-27.md) — Scored results across all 3 arms (single Opus / Fugu / self-consistency). Decision: **Trial** — Fugu wins on research breadth and risk-critique depth with real citations, but ~5× cost and ~10× latency keep it a niche backstop, not a default.
- [Researcher Agent Best-Practice Setup](researcher-agent-best-setup/REPORT.md) — 2026 research on building a stronger researcher agent stack, including retrieval, source discipline, QA, and enforcement gaps.
